export const PERMISSIONS = {
  ...
  APPROVE_MATERIAL:         "APPROVE_MATERIAL",         // legacy — kept for compatibility
  APPROVE_MATERIAL_REQUEST: "APPROVE_MATERIAL_REQUEST", // approve / reject material issue requests
  FULFILL_MATERIAL_REQUEST: "FULFILL_MATERIAL_REQUEST", // صرف فعلي للمواد بعد الموافقة
